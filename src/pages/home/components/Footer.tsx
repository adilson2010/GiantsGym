      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="border-t border-white/20 pt-6 sm:pt-8 text-center">
          <p className="text-white/80 text-xs sm:text-sm">
            © 2025 Giants Gym Cotia. Todos os direitos reservados. | <a href="https://readdy.ai/?ref=logo" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[#FFB84D] transition-colors duration-300 cursor-pointer">Website Builder</a>
          </p>
        </div>
      </div>
    </footer>
